...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
        <a class="navbar-brand" href="index.html"><img src="./images/icons8-marker-48.png" style="width: 25px;">NIDA FOOD TSP</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Data Toko">
                    <a class="nav-link" href="datatoko.php">
                        <i class="fa fa-fw fa-truck"></i>
                        <span class="nav-link-text">Data Toko</span>
                    </a>
                </li>
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Data Toko">
                    <a class="nav-link" href="tambah.php">
                        <i class="fa fa-fw fa-plus"></i>
                        <span class="nav-link-text">Tambah Toko</span>
                    </a>
                </li>
