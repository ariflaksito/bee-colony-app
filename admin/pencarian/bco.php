...
Class sarangLebah{
	...
	public static function newSarangLebah($m_totalLebah, $m_totalLebahNonaktif, $m_totalLebahAktif, $m_totalLebahPencari, $m_totalPerjalanan, $m_totalIterasi, $m_daftarToko, $m_teks){
		...
		$instance->teks .= "<h3>Inisialisasi populasi dengan jalur acak" . "</h3>";
	...
	Public Function prosesPerhitungan(){
		$this->teks .= "<br />" . "<h3>Memulai proses perhitungan algoritma Artifical Bee Colony" . "</h3>";
...
try{
	...
	$daftarToko = array();
	$idxToko=0;
	$sql=mysqli_query($koneksi, "SELECT * from tb_daftar_toko WHERE id_toko in (".$pidToko.")");
